...
### Annotated Dataset
- **NIH Chest X-ray** (public, educational use)  
- 15 images annotated  
- Tools: CVAT (free online platform)
...
**Artifacts & Devices**:
- Pacemaker (including leads/cables)  
...
- CT Annotation Portfolio
- MRI Annotation Portfolio

### Open to Opportunities
Remote freelance or full-time roles in:  
