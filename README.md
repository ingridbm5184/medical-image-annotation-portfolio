...
- 15 images from NIH Chest X-ray dataset
- Pathologies & artifacts: Pneumonia, Cardiomegaly, Nodule, Effusion, Atelectasis, Consolidation, Infiltration, Emphysema, Fibrosis, Mass, Pacemaker, CVC, Sternal Wires, Surgical Clips, etc.
- Tools: CVAT (bounding boxes & polygons)

### Mamografía Annotations
- 9 images (CC, MLO and magnification views)
